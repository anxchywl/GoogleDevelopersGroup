...
const en = {
  ...
  jams: {
    ...
    steps: [
      ...
      { title: "Coffee break", body: "Coffee and time to finish the slides." },
...
const kk: typeof en = {
  ...
  jams: {
    ...
    steps: [
      ...
      { title: "Кофе-брейк", body: "Кофе және слайдтарды аяқтауға уақыт." },
...
const ru: typeof en = {
  ...
  jams: {
    ...
    steps: [
      ...
      { title: "Кофе-брейк", body: "Кофе и время доделать слайды." },
