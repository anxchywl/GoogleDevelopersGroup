...
export const event = {
  ...
  githubUrl: known("https://github.com/anxchywl", "site author profile, repository link pending"),
  proposedDomain: "nu-datathon.anxchywl.dev",
  sources: {
    proposal,
    profile,
